...
//                                Analytics.logEvent("trust_connetion",parameters: nil);
                        ...
                        //--------------- Compare with Certificate file -------
            
                            
//
//                            if let serverCertificate = SecTrustGetCertificateAtIndex(serverTrust, 0), let serverCertificateKey = URLSessionPinningDelegate.publicKey(for: serverCertificate) {
//                                if URLSessionPinningDelegate.pinnedKeys().contains(serverCertificateKey) {
//                                    completionHandler(.useCredential, URLCredential(trust: serverTrust))
//                                    return
//                                }
//                            }
//                        }
        ...
        // Pinning failed
        // Allow connection even wrong certificate or public key just for pilot testing
//        completionHandler(Foundation.URLSession.AuthChallengeDisposition.useCredential, URLCredential(trust: challenge.protectionSpace.serverTrust!))
//        Analytics.logEvent("untrust_connetion",parameters: nil);
        
        
        // Uncomment this when you want to drop connection when certificate or public key not correct
